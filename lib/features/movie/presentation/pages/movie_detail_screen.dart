...
class MovieDetailContent extends StatelessWidget {
                    ...
                    child: ShaderMask(
                      ...
                      child: CachedNetworkImage(
                        ...
                        imageUrl: AppConstants.imageUrl(
                            state.movieDetailEntity!.backdropPath),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              child: Text(
                                state.movieDetailEntity!.releaseDate
                                    .split('-')[0],
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  (state.movieDetailEntity!.voteAverage / 2)
                                      .toStringAsFixed(1),
                                  style: const TextStyle(
                                    fontSize: 16.0,
                                    fontWeight: FontWeight.w500,
                        ...
                        const SizedBox(height: 8.0),
                        Text(
                          '${AppStrings.genres}: ${_showGenres(state.movieDetailEntity!.genres)}',
                          style: const TextStyle(
                            color: Colors.white70,
                            fontSize: 12.0,
                            fontWeight: FontWeight.w500,
  ...
  Widget _showRecommendations() {
    return BlocBuilder<MovieDetailsBloc, MovieDetailsState>(
        builder: (context, state) {
      switch (state.recommendationsMovieState) {
        case RequestState.loading:
          return const SizedBox(
              height: 400.0, child: Center(child: CircularProgressIndicator()));
        case RequestState.loaded:
          return SliverGrid(
            delegate: SliverChildBuilderDelegate(
              (context, index) {
                final recommendation = state.recommendationsEntity[index];
                return FadeInUp(
                  from: 20,
                  duration: const Duration(milliseconds: 500),
                  child: ClipRRect(
              ...
              childCount: state.recommendationsEntity.length,
            ),
        ...
        case RequestState.error:
          return Center(
            child: Text(state.recommendationsMovieMessage),
          );
      }
    });
  }
